...
<div class="auth-login-page">
    <div class="auth-login-container" style="max-width: 520px;">
        <!-- Branding Header -->
        <div class="text-center mb-4" data-aos="fade-down">
            <div class="auth-brand-logo mx-auto">
                <i class="bi bi-person-plus text-warning"></i>
            </div>
            <h1 class="h3 fw-bold text-dark mb-1">Create Account</h1>
            <p class="text-muted small">Register to order LPG cylinders and track deliveries</p>
        </div>

        <!-- Registration Card -->
        <div class="auth-card p-4 p-md-5" style="max-height: 85vh; overflow-y: auto;" data-aos="fade-up" data-aos-delay="100">
            
            <h2 class="h5 fw-bold text-dark mb-1">Customer Registration</h2>
            <p class="text-muted small mb-3">Fill in the details below to create your account</p>
            ...
            <form action="<?= url('register.php') ?>" method="POST" enctype="multipart/form-data" novalidate id="registerForm">
                ...
                <div class="row g-3">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade show active" id="cameraPane" role="tabpanel" aria-labelledby="camera-tab">
                                <div class="id-camera-container border rounded-3 p-3 bg-light" id="cameraContainer">
                                    ...
                                    <div id="cameraIdle" class="text-center py-3">
                                        <i class="bi bi-camera-video d-block mb-2" style="font-size: 2rem; color: var(--app-primary);"></i>
                                        <p class="text-muted small mb-2">Take a clear photo of your government-issued ID.</p>
                                    ...
                                    <div id="cameraActive" class="d-none">
                                        <div class="position-relative rounded-3 overflow-hidden bg-dark" style="max-height: 300px;">
                                            <video id="cameraVideo" class="w-100 d-block" autoplay playsinline style="max-height: 300px; object-fit: contain;"></video>
                                    ...
                                    <div id="cameraPreview" class="d-none text-center">
                                        <div class="position-relative d-inline-block">
                                            <img id="capturedImage" class="img-fluid rounded-3 border" style="max-height: 250px;" alt="Captured ID">
                                    ...
                                    <div id="cameraError" class="d-none">
                                        <div class="alert alert-warning d-flex align-items-center mb-0" role="alert">
                                            ...
                                            <div>
                                                ...
                                                <div class="extra-small text-muted">Please allow camera access or use file upload instead.</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-text extra-small mt-2">
                                    <i class="bi bi-info-circle me-1"></i>Passport, driver's license, national ID, etc.
                                </div>
                            </div>
                    ...
                    <div class="col-12">
                        <div class="p-3 rounded-3 border small" style="background: rgba(37, 99, 235, 0.03);">
                    ...
                    <div class="col-12 mt-4">
                        <button type="submit" class="btn btn-primary w-100 py-2 fw-semibold" id="registerSubmitBtn">
                            <span class="btn-text"><i class="bi bi-person-plus-fill me-2"></i>Create Customer Account</span>
                        </button>
                    </div>
            ...
            <div class="text-center pt-3 border-top mt-4">
                <p class="text-muted small mb-0">
                    ...
                    <a href="<?= url('index.php') ?>" class="fw-semibold text-decoration-none ms-1" style="color: var(--app-primary);">
                        Sign in here
                    </a>
                </p>
            </div>
